...
namespace KirbyGame
{
    class WaddleDeeTest : EnemytypeTest
    {
        ...
        {
            if(collider is Avatar || (collider is Boomerang && ((Boomerang)collider).hurtKirby == false) || (collider is LazerProjectile && ((LazerProjectile)collider).hurtKirby == false) || collider is Star || collider is AirPuff)
            {
